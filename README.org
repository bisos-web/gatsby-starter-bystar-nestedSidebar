#+TITLE: 🌳 Gatsby Starter: ByStar Nested Sidebar
#+AUTHOR: ByStar Team
...
- [[#-key-features][✨ Key Features]]
  ...
  - [[#️-embedded-content][🎞️ Embedded Content]]
...
- [[#-tailwind-css-implementation-guide][🎨 Tailwind CSS Implementation Guide]]
  - [[#styling-with-tailwind-css-v3][Styling with Tailwind CSS v3]]
  - [[#key-learning-tailwind-v3-standard-configuration][Key Learning: Tailwind v3 Standard Configuration]]
...
- [[#-deployment][🚀 Deployment]]
  ...
  - [[#deploy-to-netlify-or-vercel][Deploy to Netlify or Vercel]]
